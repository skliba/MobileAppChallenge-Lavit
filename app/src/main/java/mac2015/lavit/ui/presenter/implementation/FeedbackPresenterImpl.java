 ...
 */
public class FeedbackPresenterImpl extends BasePresenter implements FeedbackPresenter, SendFeedbackInteractor.SendCallback, SendImageTestInteractor.Callback {
    ...
    @Inject
    SendImageTestInteractor sendImageTestInteractor;
    ...
    @Override
    public void onImageSendError(String msg) {
        Log.e(TAG, "ISE " + msg);
    }

    @Override
    public void onImageSendSuccess(String msg) {
        Log.i(TAG, "ISS: " + msg);
    }
}
