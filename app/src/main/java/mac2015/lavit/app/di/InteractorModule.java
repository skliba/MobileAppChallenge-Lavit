...
import mac2015.lavit.domain.interactor.impl.SendImageTestInteractorImpl;
...
public class InteractorModule {
    ...
    @Provides
    public SendImageTestInteractor provideSendImageTestInteractor(InteractorExecutor interactorExecutor, MainThreadExecutor mainThreadExecutor, @Named("production_api") ListRepository listRepository) {
        return new SendImageTestInteractorImpl(interactorExecutor, mainThreadExecutor, listRepository);
    }
}
